...
const NavLink = ({ to, children }: { to: string; children: React.ReactNode }) => {
  ...
  return (
    <Link
      to={to}
      className={`relative flex items-center justify-center px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 overflow-hidden group
        ${isActive 
          ? 'text-white' 
    ...
    <QueryClientProvider client={queryClient}>
      <Router>
        <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200">
          <nav className="sticky top-0 z-50 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.3)] backdrop-blur-xl h-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
                ...
                <Link to="/" className="flex items-center space-x-3 group">
                  <div className="relative">
                    ...
                    <img
                      ...
                      alt="NASA Logo"
                      className="h-12 w-12 transition-all duration-300 group-hover:scale-110 group-hover:rotate-12 relative z-10"
                    />
                  </div>
              ...
              <div className="md:hidden">
                <button
                  ...
                  className="inline-flex items-center justify-center p-2 rounded-xl text-gray-400 hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20 transition-all duration-300"
                >
